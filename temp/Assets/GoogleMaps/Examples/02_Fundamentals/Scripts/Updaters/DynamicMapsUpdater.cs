...
namespace Google.Maps.Examples {
  ...
  public class DynamicMapsUpdater : MonoBehaviour {
    ...
    void Update() {
      ...
      Quaternion cameraRotation = player.transform.rotation * Camera.main.transform.rotation; //transform camera's local rotation towards world rotation.
      ...
      if (distanceSqr > (CameraMoveDistance * CameraMoveDistance))
      {
         //  Debug.Log("Dynamic Move Floating Origin");
         BaseMapLoader.MapsService.MoveFloatingOrigin(cameraPosition, new[] { Camera.main.gameObject });
      }

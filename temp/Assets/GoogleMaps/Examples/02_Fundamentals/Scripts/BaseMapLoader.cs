...
namespace Google.Maps.Examples {
  ...
  public class BaseMapLoader : MonoBehaviour {
    ...
    //public LatLng LatLng = new LatLng(22.59625, 113.98845); //Set initial location to Tanglang City
    public LatLng LatLng;
    //public LatLng TanglangLatLng = new LatLng(22.58645, 113.97615); //Set initial location to the leftbottom of map
    public Vector3 TanglangCoord_leftbottom;
    public Vector3 TanglangLocation_offset = new Vector3(-758.9515f, 0.0f, 417.8163f);
    ...
    void Awake() {
      ...
      TanglangMap = GameObject.Find("TanglangCity");
            if (TanglangMap == null)
                Debug.Log("Cannot find city map.");
    }
    ...
    void Start() {
      ...
      /*
      // Relocate and rescale the map tile to its correspoinding Unity coordinates
      // according to its real-word latitude and longitude.
      TanglangCoord_leftbottom = this.MapsService.Projection.FromLatLngToVector3(new LatLng(22.58645, 113.97615));//22.58645, 113.97615
      //TanglangCoord_topright = this.MapsService.Projection.FromLatLngToVector3(new LatLng(22.60887, 114.00784));
      //Debug.Log("Tanglang Coord Leftbottom:" + TanglangCoord_leftbottom.x + "," + TanglangCoord_leftbottom.z);
      //Debug.Log("Tanglang Coord Topright:" + TanglangCoord_topright.x + "," + TanglangCoord_topright.z);
      TanglangMap.transform.position = new Vector3(TanglangCoord_leftbottom.x, TanglangMap.transform.position.y, TanglangCoord_leftbottom.z);
      //TanglangMap.transform.position = new Vector3(TanglangCoord_leftbottom.x +
      //    TanglangLocation_offset.x, TanglangMap.transform.position.y, 
      //    TanglangCoord_leftbottom.z + TanglangLocation_offset.z);
      //TanglangMap.transform.localScale = new Vector3(100f, 100f, 100f);
      */
